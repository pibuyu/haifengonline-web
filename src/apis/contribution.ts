import {
    AreateArticleContributionReq,
    GetArticleContributionListByUserReq,
    GetArticleClassificationListRes,
    getArticleTotalInfoRes,
    UpdateArticleContributionReq
} from "@/types/creation/contribute/contributePage/articleContribution";
import {
    CreateVideoContributionReq,
    UpdateVideoContributionReq
} from "@/types/creation/contribute/contributePage/vdeoContribution";
import {
    DeleteArticleByIDReq,
    GetArticleManagementListReq,
    GetArticleManagementListRes
} from "@/types/creation/manuscript/article";
import {
    DeleteVideoByIDReq,
    GetVideoManagementListReq,
    GetVideoManagementListRes
} from "@/types/creation/manuscript/video";
import {
    GetDiscussArticleListReq,
    GetDiscussArticleListRes,
    GetDiscussVideoListReq,
    GetDiscussVideoListRes
} from "@/types/creation/discuss/comment";
import {
    ArticlePostCommentReq,
    GetArticleCommentReq,
    GetArticleCommentRes,
    GetArticleContributionByIDReq,
    GetArticleContributionByIDRes
} from "@/types/show/article/article";
import {
    GetVideoContributionByIDReq,
    GetVideoContributionByIDRes,
    VideoPostCommentReq,
    GetVideoBarrageListReq,
    GetVideoBarrageListRes,
    SendVideoBarrageReq,
    GetVideoCommentReq,
    GetVideoCommentRes,
    LikeVideoReq,
    GetVideoCommentCountByIdReq, GetVideoCommentCountById, GetLastWatchTime, SendWatchTimeReq
} from "@/types/show/video/video";
import {
    GetArticleContributionListReq,
    GetArticleContributionListRes,
    GetColumnByClassificationIdReq
} from "@/types/home/column";
...
//根据专栏分类的id重新请求专栏信息
export const getColumnByClassificationId = (params: GetColumnByClassificationIdReq) => {
    return httpRequest.post<GetArticleContributionListRes>('/contribution/getColumnByClassificationId', params);
}
//根据用户获取专栏信息
...
//获取视频观看进度
export const getLatWatchTime=(params:GetLastWatchTime)=>{
    return httpRequest.get<GetLastWatchTime>('/contribution/getLastWatchTime', params);
}

//发送视频观看进度
export const sendWatchTime=(params:SendWatchTimeReq) => {
    return httpRequest.post<SendWatchTimeReq>('/contribution/sendWatchTime', params);
}
...
//根据视频id获取评论总条数
export const getVideoCommentCountById = (params: GetVideoCommentCountByIdReq) => {
    return httpRequest.post<GetVideoCommentCountById>('/contribution/getVideoCommentCountById', params)
}
