    ...
    <div :class="{ active: currentModel, container: true,animate__animated :true, animate__flipInX :true}" >
      ...
      <div class="form-container sign-in-container">
        ...
        >
          ...
          <el-form-item class="form-item" prop="username">
            <el-input v-model="loginForm.username" type="text" placeholder="用户名" @keyup.enter="login(loginFormRef)" />
          </el-form-item>
          <el-form-item class="form-item" prop="passwoed" @keyup.enter="login(loginFormRef)">
            <el-input
          ...
          <p
            ...
            "
          >
            <span class="resetPass"> Forget Password</span>
          </p>
        </el-form>
      </div>
      <!--覆盖容器-->
